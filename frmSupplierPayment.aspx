...
<%--
                            <asp:TextBox ID="" runat="server" AutoPostBack="True" CssClass="txtVisibleAlign"
            ontextchanged="" placeholder="Search By Supplier.." 
        ...
        <ajaxToolkit:autocompleteextender ID="txtSupplierSearch_AutoCompleteExtender" runat="server" 
            ...
            MinimumPrefixLength="1" ServiceMethod="GeGetSupplierForSearch" 
            ServicePath="AutoComplete.asmx" TargetControlID="txtSupplierSearch" />--%>
            
            
              <asp:TextBox ID="txtSupplierSearch" runat="server" Width="98%" placeHolder="Search Supplier..!!"
                                AutoPostBack="True" ontextchanged="txtSupplierSearch_TextChanged" 
                            ...
                            <ajaxToolkit:AutoCompleteExtender ServicePath="AutoComplete.asmx" runat="server" 
                                                              ID="AutoCompleteExtender3" TargetControlID="txtSupplierSearch"
                                                              ServiceMethod="GetSupplierForSearch" 
