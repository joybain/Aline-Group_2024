...
public partial class SalesVoucher : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            txtInvoiceNo.Text = IdManager.GetDateTimeWiseSerial("YG_", "InvoiceNo", "[Order]");
    ...
    private void getEmptyDtl()
    {
        ...
        dtDtlGrid.Columns.Add("PackSize", typeof(string));
        dtDtlGrid.Columns.Add("msr_unit_code", typeof(string));
        dtDtlGrid.Columns.Add("Total", typeof(string));
        dtDtlGrid.Columns.Add("OrderQty", typeof(string));
        dtDtlGrid.Columns.Add("ClosingStock", typeof(string));
        DataRow dr = dtDtlGrid.NewRow();
        dtDtlGrid.Columns.Add("SalesClosingStock", typeof(string));
        dtDtlGrid.Columns.Add("SqmClosingStock", typeof(string));
        dtDtlGrid.Columns.Add("SftClosingStock", typeof(string));
    ...
    private void ShowFooterTotal(DataTable DT1)
    {
        ...
        txtGrandTotal.Text = txtDue.Text = (tot + ((tot * totVat) / 100)).ToString("F");
    ...
    private void Quantity(object sender)
    {
        ...
        catch
        {
            ...
            gvr = (GridViewRow)((DropDownList)sender).NamingContainer;
        }
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            if (dr["msr_unit_code"].ToString() == "R")
            {
            ...
            else if (dr["msr_unit_code"].ToString() == "C")
            {
                if (Convert.ToDouble(dr["SalesClosingStock"]) < Convert.ToDouble(((TextBox)gvr.FindControl("txtQty")).Text))
                {
                    string Mgs = "Items Quantity Over This Closing Quantity.\\n Tolat Closing Qiantity:-(" + dr["ClosingStock"] + ")..!!";
                    ClientScript.RegisterStartupScript(this.GetType(), "Warning", "alert('" + Mgs + "');", true);
            ...
            else if (dr["msr_unit_code"].ToString() == "SF")
            {
                if (Convert.ToDouble(dr["SftClosingStock"]) < Convert.ToDouble(((TextBox)gvr.FindControl("txtQty")).Text))
                {
                    string Mgs = "Items Quantity Over This Closing Quantity.\\n Tolat Closing Qiantity:-(" + dr["SftClosingStock"] + ")..!!";
                    ClientScript.RegisterStartupScript(this.GetType(), "Warning", "alert('" + Mgs + "');", true);
            ...
            else if (dr["msr_unit_code"].ToString() == "SQ")
            {
                if (Convert.ToDouble(dr["SqmClosingStock"]) < Convert.ToDouble(((TextBox)gvr.FindControl("txtQty")).Text))
                {
                    string Mgs = "Items Quantity Over This Closing Quantity.\\n Tolat Closing Qiantity:-(" + dr["SqmClosingStock"] + ")..!!";
                    ClientScript.RegisterStartupScript(this.GetType(), "Warning", "alert('" + Mgs + "');", true);
    ...
    {
        DataTable dtmsr = GetMeasure();
        DataRow dr = dtmsr.NewRow();
        // dtmsr.Rows.InsertAt(dr, 0);
        return dtmsr;
    }

    private DataTable GetMeasure()
    {
        DataTable dtDtlGrid = new DataTable();
        dtDtlGrid.Columns.Add("ID", typeof(string));
        dtDtlGrid.Columns.Add("Name", typeof(string));
        ...
        DataRow dr1 = dtDtlGrid.NewRow();
        dr1["Id"] = "SF";
        dr1["Name"] = "SFT";
        dtDtlGrid.Rows.Add(dr1);

        DataRow dr2 = dtDtlGrid.NewRow();
        dr2["Id"] = "R";
        dr2["Name"] = "ROLL";
        dtDtlGrid.Rows.Add(dr2);

        DataRow dr3 = dtDtlGrid.NewRow();
        dr3["Id"] = "SQ";
        dr3["Name"] = "SQM";
        dtDtlGrid.Rows.Add(dr3);
    ...
    protected void btnFind_Click(object sender, EventArgs e)
    {
        ...
        if (aSales != null)
        {
            ...
            txtDriverName.Text = aSales.DriverName;
            txtDriverPhoneNo.Text = aSales.DriverPhoneNo;
            txtCarNo.Text = aSales.CarNo;
            hfOutTime.Value = aSales.OutTime;
            //ddlCustomer.SelectedValue = aSales.Customer;
            ...
            Dis = (Convert.ToDecimal(txtSubTotal.Text) * Convert.ToDecimal(txtDiscount.Text)) / 100;

            decimal vat = 0;

            vat = ((Convert.ToDecimal(txtSubTotal.Text) - Dis) * Convert.ToDecimal(txtVat.Text)) / 100;

            decimal tot = (Convert.ToDecimal(txtSubTotal.Text) + vat - Dis);
            txtGrandTotal.Text = tot.ToString("N2");
        ...
        else
        {
            ...
            if (aSales != null)
            {
                if (per.AllowEdit == "Y")
                {
                    ...
                    aSales.GTotal = txtGrandTotal.Text;
                        //(Convert.ToDouble(txtSubTotal.Text) - Dis).ToString().Replace(",", "");
                    ...
                    aSales.DriverName = txtDriverName.Text;
                    aSales.DriverPhoneNo = txtDriverPhoneNo.Text;
                    aSales.CarNo = txtCarNo.Text;
                    //aSales.OutTime = DateTime.Now.ToString("h:mm:ss tt");
            ...
            else
            {
                ...
                else
                {
                    if (per.AllowAdd == "Y")
                    {
                        ...
                        {
                            if (string.IsNullOrEmpty(ViewState["SalesOrderId"].ToString()))
                            {
                            ...
                            {
                                SalesManager.SaveSalesInfo(aSales, dt, ViewState["SalesOrderId"].ToString());
    ...
    {
        Response.Redirect("SalesVoucher.aspx?mno=1.10");
    }
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            {
                cell = new PdfPCell(new Phrase("Customer Copy", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 11, iTextSharp.text.Font.BOLD)));
                cell.HorizontalAlignment = 1;
                cell.VerticalAlignment = 1;
                cell.Colspan = 7;
                cell.BorderWidth = 0f;
            ...
            cell = new PdfPCell(new Phrase("INVOICE/BILL", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 11, iTextSharp.text.Font.BOLD)));
            cell.HorizontalAlignment = 1;
            cell.VerticalAlignment = 1;
            cell.Colspan = 7;
            cell.BorderWidth = 0f;
            ...
            PdfPTable pdtclient1 = new PdfPTable(4);
            pdtclient.WidthPercentage = 100;
            cell = new PdfPCell(FormatHeaderPhrase("Delivered/Sold to"));
            cell.BorderWidth = 0f;
            //cell.FixedHeight = 20f;
            pdtclient1.AddCell(cell);
            cell = new PdfPCell(FormatPhrase(": " + ddlCustomer.SelectedItem.Text));
            cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            cell.Colspan = 3;
            pdtclient1.AddCell(cell);
            string Address = IdManager.GetShowSingleValueString("Address1", "ID", "Customer", ddlCustomer.SelectedValue);
            cell = new PdfPCell(FormatHeaderPhrase("Address :"));
            cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            pdtclient.AddCell(cell);
            cell = new PdfPCell(FormatPhrase(": " + Address));
            cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            cell.Colspan = 3;
            pdtclient.AddCell(cell);
            ...
            float[] widthdtl = new float[8] { 15, 50, 12, 20, 20, 20, 20, 25 };
            ...
            cell = new PdfPCell(FormatHeaderPhrase("Pack size"));
            cell.HorizontalAlignment = 1;
            cell.VerticalAlignment = 1;
            cell.FixedHeight = 20f;
            cell.BorderColor = BaseColor.LIGHT_GRAY;
            ...
            foreach (DataRow dr in DT1.Rows)
            {
                ...
                cell = new PdfPCell(FormatPhrase(dr["UOM"].ToString() + "/" + dr["msr_unit_code"].ToString()));
                cell.HorizontalAlignment = 1;
                cell.VerticalAlignment = 1;
                cell.BorderColor = BaseColor.LIGHT_GRAY;
                pdtdtl.AddCell(cell);
                ...
                cell = new PdfPCell(FormatPhrase(dr["PackSize"].ToString()));
                cell.HorizontalAlignment = 1;
                cell.VerticalAlignment = 1;
                cell.BorderColor = BaseColor.LIGHT_GRAY;
                pdtdtl.AddCell(cell);
            ...
            cell = new PdfPCell(FormatPhrase(Dis.ToString("N2")));
            //cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            cell.HorizontalAlignment = 2;
            cell.VerticalAlignment = 1;
            ...
            cell = new PdfPCell(FormatPhrase(vat.ToString("N2")));
            //cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            cell.HorizontalAlignment = 2;
            cell.VerticalAlignment = 1;
            ...
            cell = new PdfPCell(FormatPhrase("In word: " + DataManager.GetLiteralAmt((Convert.ToDecimal(txtGrandTotal.Text)).ToString()).Replace("  ", " ").Replace("  ", " ")));
            cell.VerticalAlignment = 1;
            cell.HorizontalAlignment = 0;
            cell.BorderWidth = 0f;
    ...
    protected void btnChallan_Click(object sender, EventArgs e)
    {
        ...
        for (int a = 0; a < 3; a++)
        {
            ...
            if (a == 2)
            {
                cell = new PdfPCell(new Phrase("Challan Delivery", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 11, iTextSharp.text.Font.BOLD)));
                cell.HorizontalAlignment = 1;
                cell.VerticalAlignment = 1;
                cell.Colspan = 7;
                cell.BorderWidth = 0f;
            ...
            {
                cell = new PdfPCell(new Phrase("Gate Pass", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 11, iTextSharp.text.Font.BOLD)));
                cell.HorizontalAlignment = 1;
                cell.VerticalAlignment = 1;
                cell.Colspan = 7;
                cell.BorderWidth = 0f;
            ...
            //if (a > 0)
            //{
            //    cell = new PdfPCell(new Phrase("(Customer Copy)", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 8, iTextSharp.text.Font.NORMAL)));
            //    cell.HorizontalAlignment = 1;
            //    cell.VerticalAlignment = 1;
            //    cell.Colspan = 7;
            //    cell.BorderWidth = 0f;
            ...
            //    cell = new PdfPCell(new Phrase("(Office Copy)", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 8, iTextSharp.text.Font.NORMAL)));
            //    cell.HorizontalAlignment = 1;
            //    cell.VerticalAlignment = 1;
            //    cell.Colspan = 7;
            //    cell.BorderWidth = 0f;
            ...
            pdtclient.WidthPercentage = 100;
            cell = new PdfPCell(FormatHeaderPhrase("Driver Name"));
            cell.BorderWidth = 0f;
            //cell.FixedHeight = 20f;
            pdtclient.AddCell(cell);
            cell = new PdfPCell(FormatPhrase(": " + txtDriverName.Text));
            cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            cell.Colspan = 3;
            pdtclient.AddCell(cell);
            cell = new PdfPCell(FormatHeaderPhrase("Car No :"));
            cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            pdtclient.AddCell(cell);
            // string Phone = IdManager.GetShowSingleValueString("Mobile", "ID", "Customer", ddlCustomer.SelectedValue);
            cell = new PdfPCell(FormatPhrase(": " + txtCarNo.Text));
            cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            cell.Colspan = 3;
            pdtclient.AddCell(cell);
            ...
            cell.FixedHeight = 20f;
            pdtpur.AddCell(cell);
            cell = new PdfPCell(FormatPhrase(": " + txtInvoiceNo.Text.Replace("YG_", "CH")));
            cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            pdtpur.AddCell(cell);
            ...
            cell = new PdfPCell(FormatHeaderPhrase("Driver Phone No :"));
            cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            pdtpur.AddCell(cell);
            cell = new PdfPCell(FormatPhrase(": " + txtDriverPhoneNo.Text));
            cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            pdtpur.AddCell(cell);

            cell = new PdfPCell(FormatHeaderPhrase("Out Time"));
            cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            pdtpur.AddCell(cell);
            cell = new PdfPCell(FormatPhrase(": " + hfOutTime.Value));
            cell.BorderWidth = 0f;
            cell.FixedHeight = 20f;
            pdtpur.AddCell(cell);
            ...
            //document.Add(dtempty);       
            float[] widthdtl = new float[6] { 15, 50, 15, 15, 20, 20 };
            PdfPTable pdtdtl = new PdfPTable(widthdtl);
            pdtdtl.WidthPercentage = 100;
    ...
    private void DueCalaction()
    {
        var totVat = Convert.ToDecimal(txtVat.Text);
        //txtSubTotal.Text = tot.ToString();
        if (txtDiscount.Text == "")
        {
            txtDiscount.Text = "0";
        ...
        txtDue.Text = (tot - Convert.ToDecimal(txtPayment.Text)).ToString("F");
    ...
    protected void ddlMeasure_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            if (((DropDownList)gvr.FindControl("ddlMeasure")).SelectedValue == "R")
            {
                if (Convert.ToDouble(dr["ClosingStock"]) < Convert.ToDouble(((TextBox)gvr.FindControl("txtQty")).Text))
                {
                    string Mgs = "Items Quantity Over This Closing Quantity.\\n Tolat Closing Qiantity:-(" + dr["ClosingStock"] + ")..!!";
            ...
            else if (((DropDownList)gvr.FindControl("ddlMeasure")).SelectedValue == "C")
            {
                if (Convert.ToDouble(dr["SalesClosingStock"]) < Convert.ToDouble(((TextBox)gvr.FindControl("txtQty")).Text))
                {
                    string Mgs = "Items Quantity Over This Closing Quantity.\\n Tolat Closing Qiantity:-(" + dr["ClosingStock"] + ")..!!";
    ...
    protected void txtPackSize_TextChanged(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            dr["PackSize"] = ((TextBox)gvr.FindControl("txtPackSize")).Text;

        }
        dgSV.DataSource = dt;
        dgSV.DataBind();
        ShowFooterTotal(dt);
        ((TextBox)dgSV.Rows[dgSV.Rows.Count - 1].FindControl("txtPackSize")).Focus();
    }
    protected void txtSO_TextChanged(object sender, EventArgs e)
    {
        DataTable dt = PurchaseOrderManager.GetShowSalesOrder(txtSO.Text);
        if (dt.Rows.Count > 0)
        {
            txtSO.Text = dt.Rows[0]["PO"].ToString();
            txtDate.Text = Convert.ToDateTime(dt.Rows[0]["PODate"]).ToString("dd/MM/yyyy");
            ddlCustomer.SelectedValue = dt.Rows[0]["CustomerID"].ToString();
  
            hfSalesOrderId.Value = dt.Rows[0]["ID"].ToString();
            ViewState["SalesOrderId"] = dt.Rows[0]["ID"].ToString();
            ...
            DataTable dt1 = SalesManager.GetShowItemsInformationSalesOrder(dt.Rows[0]["ID"].ToString());
            if (dt1.Rows.Count > 0)
            {
                dgSV.DataSource = dt1;
                ViewState["SV"] = dt1;
            ...
            {
                ClientScript.RegisterStartupScript(this.GetType(), "Warning", "alert('Item Are not Ready');", true);
                txtSO.Text = "";
                txtDate.Text ="";
                ddlCustomer.SelectedValue = "";

                hfSalesOrderId.Value = "";
                ViewState["SalesOrderId"] = "";
            }
