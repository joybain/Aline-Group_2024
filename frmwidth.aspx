<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmwidth.aspx.cs" Inherits="frmwidth" %>
...
<FooterTemplate> 
 ...
 <asp:TemplateField  HeaderText="ID" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center"
  FooterStyle-HorizontalAlign="Center">
 <ItemTemplate>
 <asp:Label ID="lblMsrUnitCode" runat="server" Text='<% # Eval("ID") %>' Width="80px"></asp:Label>
 </ItemTemplate>
 <EditItemTemplate>
 <asp:TextBox SkinID="tbPlain" ID="txtMsrUnitCode" runat="server" Text='<% # Eval("ID") %>' Width="80px" Font-Size="8pt" CssClass="tbc"></asp:TextBox>
 </EditItemTemplate>
 <FooterTemplate>
 ...
 <asp:TemplateField  HeaderText="Width" ItemStyle-Width="230px" ItemStyle-HorizontalAlign="Left">
 <ItemTemplate>
 <asp:Label ID="lblMsrUnitDesc" runat="server" Text='<% # Eval("Name") %>' Width="230px"></asp:Label>
 </ItemTemplate>
 <EditItemTemplate>
 <asp:TextBox SkinID="tbPlain" ID="txtMsrUnitDesc" runat="server" Text='<% # Eval("Name") %>' Width="230px" Font-Size="8pt" AutoPostBack="false"></asp:TextBox>
 </EditItemTemplate> 
 <FooterTemplate>
