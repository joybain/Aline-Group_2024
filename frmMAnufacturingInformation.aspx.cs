...
public partial class frmMAnufacturingInformation : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            pnlReceivedFinal.Visible = pnlConsumption.Visible = false;
    ...
    protected void TreeView1_SelectedNodeChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            lblreceivedFianl.Text = TreeView1.SelectedNode.Text + " (Finish Goods) ";
            ...
            Session["SerialNo"] = dtproduction.Rows[0]["SerialNo"].ToString();
            getEmptyDtlConsumtion();
            getEmptyDtlfinal();
            getEmptyDtl();
            ...
            if (TreeView1.SelectedValue == "100")
            {
            ...
            DataTable dt = ManufactureInformationManager.GetInformationHistory("", TreeView1.SelectedValue);
            ...
            try
            {
                ...
                txtManufactureCode.Text =
                             IdManager.GetShowSingleValueString(
                                 "select right(Convert(nvarchar,YEAR(GetDate())),2)+right('00'+Convert(nvarchar,MONTH(GETDAte())),2)+right('00'+CONVERT(Nvarchar,isnull('" + Session["userID"].ToString() + "',0)),2)+right('000000'+Convert(nvarchar,(select top(1) ID from Manufacturing_Master order by id desc)),6)  AS code");
            }
            catch
            {
            ...
            if (TreeView1.SelectedValue == "100")
            {
                txtItemReceived.Visible =
                ddllenthReceived.Visible =
                    ddlWidthReceived.Visible =
                        ddlThiknessReceived.Visible =
                            txtquantityReceived.Visible = BtnAddReceived.Visible = BtnClearReceived.Visible = true;
            ...
            else
            {
              ...
              ddllenthReceived.Visible =
                  ddlWidthReceived.Visible =
                      ddlThiknessReceived.Visible =
                          txtquantityReceived.Visible = BtnAddReceived.Visible = BtnClearReceived.Visible = false;
            }
    ...
    private void AddItemDetailsConsumption(Label ItemID, TextBox ItemConsumption, DropDownList lenthConsumption, DropDownList WidthConsumption, DropDownList ThiknessConsumption, TextBox quantityConsumption, string viewstate, GridView Consumption, Label lblItemProductionCode)
    {
        ...
        if (Session["ParentCode"] != null && Session["ParentCode"].ToString() != "0")
        {
            ...
            DataTable dtitemstock = IdManager.GetShowDataTable("Select top(1) *  from Manufacturing_Stock where Id='" + ItemID.Text + "' and WidthID='" + WidthConsumption.Text + "' and LengthID='" + lenthConsumption.Text + "' and ThiknessID='" + ThiknessConsumption.Text + "' and  ProductionSerialNo<=Convert(int,'" + serialNo + "') ");
            ...
            if (dtproduction.Rows.Count > 0)
            {
                if ((dtproduction.Rows[0]["FinalStatge"].ToString() == "True" || dtproduction.Rows[0]["FinalStatge"].ToString() == "1" ) && dtproduction.Rows[0]["FinalStatge"].ToString() != "")
                {
                   ...
                   DataTable dt = (DataTable)ViewState[viewstate];
                    ...
                    if (found == "")
                    {
                        ...
                        drd["Quantity"] = quantityReceived.Text;
                        drd["Weight"] = quantityReceived.Text;
                        dt.Rows.Add(drd);
                    }
                ...
                else
                {
                    ...
                    if (found == "")
                    {
                        ...
                        drd["Thikness"] = ThiknessReceived.SelectedItem.Text;
                        drd["Quantity"] = quantityReceived.Text;
                        drd["Weight"] = txtWeight.Text;
                        dt.Rows.Add(drd);
                    }
                    Received.DataSource = dt;
                    Received.DataBind();
                    ViewState[viewstate] = dt;
                    ItemID.Text = ItemReceived.Text = txtWeight.Text="";
                    quantityReceived.Text = "0";
                    lenthReceived.SelectedIndex = WidthReceived.SelectedIndex = ThiknessReceived.SelectedIndex = -1;
                }
            }
    ...
    private void AddItemDetailsConsumption(Label ItemID, TextBox ItemConsumption, DropDownList lenthConsumption, DropDownList WidthConsumption, DropDownList ThiknessConsumption, TextBox quantityConsumption, string viewstate, GridView Consumption)
    {
        ...
        var a = Session["ParentCode"].ToString();
        if (Session["ParentCode"] != null && Session["ParentCode"].ToString() != "0")
        {
    ...
    private void getEmptyDtlfinal()
    {
        ...
        dtDtlGrid.Columns.Add("Weight", typeof(string));
    ...
    protected void BtnAddConsumption_Click(object sender, EventArgs e)
    {
        ...
        txtItemConsumption.Focus();
      var  consumption = (DataTable)ViewState["ConsumptionDetails"];
    ...
    protected void txtItemConsumption_TextChanged(object sender, EventArgs e)
    {
        if (Session["ParentCode"] != null)
        {
          //  DataTable dt = IdManager.GetShowDataTable("Select *  from View_ItemSearch where Upper(ItemName)=Upper('" + txtItemConsumption.Text + "')  ");
            DataTable dt = IdManager.GetShowDataTable("Select *  from View_ExtruderItemSearch where Upper(ItemName)=Upper('" + txtItemConsumption.Text + "')  ");
            if (dt.Rows.Count > 0)
            {
    ...
    {
        lblItemIDConsumption.Text = txtItemConsumption.Text = lblManufacturing_StockId.Text = "";
    ...
    protected void BtnSavess_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           // return;
            ...
            {
                ClientScript.RegisterStartupScript(this.GetType(), "ale", "alert('Please Input Manufactured Date..!!');", true);
                return;
            }
            ...
            if (dtproduction.Rows.Count > 0)
            {
                DataTable Received = new DataTable();

                Received = (DataTable)ViewState["receivedDetailsFinal"];
                ...
                //else
                //{
                //    Received = (DataTable)ViewState["FNreceivedDetails"];
                //}
                //if (Received.Rows.Count <= 0 || Received == null)
                //{
                //    ClientScript.RegisterStartupScript(this.GetType(), "ale", "alert('Please Add Received Item First..!!');", true);
                //    return;
                //}
                if (dtproduction.Rows[0]["ParentCode"].ToString() == "0")
                {
                    consumption = (DataTable)ViewState["ConsumptionDetails"];
                }
                else
                {

                    consumption = (DataTable)ViewState["FNreceivedDetails"];
                }
                if (consumption.Rows.Count > 0)
                {
                    if (dtproduction.Rows[0]["ParentCode"].ToString() == "0")
                    {
                        foreach (DataRow dr in consumption.Rows)
                        {
                            DataTable dtitemstock = IdManager.GetShowDataTable("Select top(1) *  from Manufacturing_Stock where ItemID='" + dr["ItemID"].ToString() + "' and ProductionCode='" + TreeView1.SelectedValue + "' ");
                            //DataTable dtitemstock = IdManager.GetShowDataTable("Select top(1) *  from Manufacturing_Stock where Id='" + dr["ItemID"].ToString() + "' and ProductionCode='" + TreeView1.SelectedValue + "' ");
                            if (dtitemstock.Rows.Count > 0)
                            {
                               // var a = Convert.ToDecimal(dtitemstock.Rows[0]["ClosingStock"].ToString());
                                //var b = Convert.ToDecimal(dr["Quantity"].ToString());

                                if (!string.IsNullOrEmpty(hfMstID.Value))
                                {
                                    if ((Convert.ToDecimal(dtitemstock.Rows[0]["ClosingStock"].ToString()) + Convert.ToDecimal(dr["Quantity"].ToString())) < Convert.ToDecimal(dr["Quantity"].ToString()))
                                    {
                                        ClientScript.RegisterStartupScript(this.GetType(), "ale", "alert('" + dr["Name"].ToString() + " This Item Over Then Stock Quantity " + dtitemstock.Rows[0]["ClosingStock"].ToString() + " ..!!');", true);
                                        return;
                                    }
                                }
                                else
                                {
                                    if (Convert.ToDecimal(dtitemstock.Rows[0]["ClosingStock"].ToString()) < Convert.ToDecimal(dr["Quantity"].ToString()))
                                    {
                                        ClientScript.RegisterStartupScript(this.GetType(), "ale", "alert('" + dr["Name"].ToString() + " This Item Over Then Stock Quantity " + dtitemstock.Rows[0]["ClosingStock"].ToString() + " ..!!');", true);
                                        return;
                                    }
                    ...
                    else
                    {
                        foreach (DataRow dr in consumption.Rows)
                        {
                            DataTable dtitemstock = IdManager.GetShowDataTable("Select top(1) *  from Manufacturing_Stock where ID='" + dr["ItemID"].ToString() + "' --and  LengthID='" + dr["LengthID"].ToString() + "' and ThiknessID='" + dr["ThiknessID"].ToString() + "' and  ProductionCode='" + dr["ProductionCode"].ToString() + "' ");
                            if (dtitemstock.Rows.Count > 0)
                            {
                ...
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "ale", "alert('Please Add Consumption Item First..!!');", true);
                    return;
                }

                ManufactureInformation aManufactureInformation;
                aManufactureInformation = ManufactureInformationManager.GetManufactureInformation(hfMstID.Value);
                if (aManufactureInformation == null)
                {
                    ...
                    aManufactureInformation.ProductionCode = dtproduction.Rows[0]["Code"].ToString();
                    aManufactureInformation.ProductionSerial = dtproduction.Rows[0]["SerialNo"].ToString();
                    aManufactureInformation.ProductionParentCode = dtproduction.Rows[0]["ParentCode"].ToString();
                    aManufactureInformation.ProductionID = dtproduction.Rows[0]["ID"].ToString();
                    try
                    {
                  ...
                  MstID=  ManufactureInformationManager.SaveManufactureInformation(aManufactureInformation, Received, consumption, out ManufactureCode, out MstID);
                    txtManufactureCode.Text = ManufactureCode;
                    hfMstID.Value = MstID;

                    ManufactureInformationManager.UpdateItemBondingRequisitionMst(txtRequisitionNo.Text);
                ...
                else
                {
                    ...
                    ManufactureInformationManager.UpdateManufactureInformation(aManufactureInformation, Received, consumption, hfMstID.Value);
    ...
    {
        Response.Redirect("frmMAnufacturingInformation.aspx?mno=0.5");
    }
    ...
    protected void dghistory_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ManufactureInformation aManufactureInformation = ManufactureInformationManager.GetManufactureInformation(hfMstID.Value);
        if (aManufactureInformation != null)
        {
            ...
            txtManufactureCode.Text = aManufactureInformation.GenerateCode;
            txtManufactureDate.Text = aManufactureInformation.ManufagchuredDate;
            txtremarks.Text = aManufactureInformation.Remarks;
            if (aManufactureInformation.ManufagchuredBy != null && aManufactureInformation.ManufagchuredBy != "" && aManufactureInformation.ManufagchuredBy!="0")
            {
                ddlManufacturedBy.SelectedValue = aManufactureInformation.ManufagchuredBy;
            }
            else
            {
                ddlManufacturedBy.SelectedIndex = -1;
            ...
            DataTable dtproduction = IdManager.GetShowDataTable("Select top(1) *  from ProductionSetup where Code='" + aManufactureInformation.ProductionCode + "'  ");
            Session["ParentCode"] = dtproduction.Rows[0]["ParentCode"].ToString();

           
            DataTable Received = ManufactureInformationManager.GetReceivedDetailsInfo(aManufactureInformation.ID);

            DataTable Consumption = ManufactureInformationManager.GetConsumptionDetailsInfo(aManufactureInformation.ID, Session["ParentCode"].ToString());

            if (dtproduction.Rows[0]["ParentCode"].ToString() != "0" && dtproduction.Rows[0]["ParentCode"].ToString() != "")
            {          
                pnlreceived.Visible = true;
                ViewState["FNreceivedDetails"] = Consumption;               
                pnlConsumption.Visible = false;               
                dgReceived.DataSource = Consumption;
                dgReceived.DataBind();
            }
            else
            {
               
                ViewState["ConsumptionDetails"] = Consumption;
                 pnlreceived.Visible = false;              
                pnlConsumption.Visible = true;               
                dgConsumption.DataSource = Consumption;
                dgConsumption.DataBind();
            }
            pnlReceivedFinal.Visible = true;
    ...
    protected void txtRequisitionNo_TextChanged(object sender, EventArgs e)
    {
        try
        {
            DataTable Received = BondingRequisitionManager.GetReceivedDetailsInfoWithRequisition(txtRequisitionNo.Text);

            if (Received.Rows.Count > 0)
            {
                pnlReceivedFinal.Visible = true;
                ViewState["FNreceivedDetails"] = Received;
                dgReceived.DataSource = Received;
            ...
            {
                pnlReceivedFinal.Visible = false;
                ViewState["receivedDetailsFinal"] = null;
                dgReceived.DataSource = null;
                dgReceived.DataBind();
            }
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ClientScript.RegisterStartupScript(this.GetType(), "ale", "alert('First Select Production Code..!!');", true);
    ...
    {
        string filename = "MNINFO_" + TreeView1.SelectedNode.Text;
        Response.Clear();
        ...
        // cell.FixedHeight = 20f;
        dth.AddCell(cell);
        cell = new PdfPCell(new Phrase("Manufacture INFO(" + TreeView1.SelectedNode.Text + ")", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 10, iTextSharp.text.Font.BOLD)));
        cell.HorizontalAlignment = 1;
        cell.VerticalAlignment = 1;
        cell.Colspan = 7;
        cell.BorderWidth = 0f;
        ...
        cell = new PdfPCell(FormatHeaderPhrase("Prepared By:"));
        cell.BorderWidth = 0f;
        cell.FixedHeight = 20f;
        ...
        cell = new PdfPCell(FormatHeaderPhrase("Production Code."));
        cell.BorderWidth = 0f;
        cell.FixedHeight = 20f;
        pdtpur.AddCell(cell);
        ...
        cell.FixedHeight = 20f;
        pdtpur.AddCell(cell);
        cell = new PdfPCell(FormatHeaderPhrase("Manufacture  Date"));
        cell.BorderWidth = 0f;
        cell.FixedHeight = 20f;
        pdtpur.AddCell(cell);
        ...
        cell = new PdfPCell(FormatHeaderPhrase("Raw Materials"));
        cell.HorizontalAlignment = 1;
        cell.VerticalAlignment = 1;
        cell.FixedHeight = 20f;
        cell.Colspan = 8;
        ...
        ManufactureInformation aManufactureInformation = ManufactureInformationManager.GetManufactureInformation(hfMstID.Value);
        DataTable Received = ManufactureInformationManager.GetReceivedDetailsAllInfo(aManufactureInformation.ID);

        DataTable dt = ManufactureInformationManager.GetConsumptionDetailsAllInfo(aManufactureInformation.ID);
       ...
       // DataTable dt = BondingRequisitionManager.GetReceivedDetailsAllInfo(hfMstID.Value);
        ...
        if (Received!=null)
        {
            ...
            {
                cell = new PdfPCell(FormatHeaderPhrase("Finish Goods"));
                cell.HorizontalAlignment = 1;
                cell.VerticalAlignment = 1;
                cell.FixedHeight = 20f;
                cell.Colspan = 8;
                ...
                pdtdtl.AddCell(cell);
                 ...
                 totLength = 0;
                totWidth = 0;
                totThikness = 0; totQuantity = 0;
                foreach (DataRow dr in Received.Rows)
                {
                    if (Convert.ToDecimal(dr["ID"]) != 0)
                    {
                        cell = new PdfPCell(FormatPhrase(Serial.ToString()));
