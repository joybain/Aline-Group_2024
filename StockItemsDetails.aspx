       ...
       <ContentTemplate>
                        ...
                        <fieldset style="vertical-align: top; border: solid 1px #8BB381;">
                            ...
                            <td style="width:96%;" align="left">
                                <asp:RadioButtonList ID="rdbItemType" runat="server" BorderStyle="None" 
                                    ...
                                    <asp:ListItem Value="1">Raw Material Items</asp:ListItem>
                                    <asp:ListItem Value="2">Finished Good Items</asp:ListItem>
                                    <asp:ListItem Value="5">Fixed Asset</asp:ListItem>
                            ...
                            <tr>
                            <td colspan="5" style="height: 74px">
                                ...
                                <div style="width:55%;height:20px; float: left;">
                                    ...
                                    <ajaxToolkit:AutoCompleteExtender ID="autoComplete1" runat="server" 
                                        ...
                                        MinimumPrefixLength="1" ServiceMethod="GetStockItemList" 
                              ...
                              <div style="width:5%;height:20px; float: left;">
                                ...
                                <div style="width:55%;height:27px; float: left;">
                                    
                                     <asp:DropDownList SkinId="ddlPlain"  ID="ddlProjectName" runat="server" Font-Size="8pt" 
            Width="96%" Height="34px" AutoPostBack="True" onselectedindexchanged="ddlProjectName_SelectedIndexChanged" 
           >
    </asp:DropDownList>
        ...
        <tr>
            ...
            <td align="center">
             ...
             <div style="width:17%;height:28px; float: left;" >
                     <asp:Button ID="btnSerch" runat="server" 
                         Text="Search" Width="90px" onclick="btnSerch_Click1" />
&nbsp;
                </div>
                    ...
                    <td align="center" colspan="3">
                        <asp:GridView ID="dgItems" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ItemsName" HeaderText="Items Code &amp; Name">
                                ...
                                <asp:BoundField DataField="Roll" HeaderText="Roll/Qty">
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="ClosingStock" HeaderText="CFT Closing Stock">
                                <ItemStyle HorizontalAlign="Center" Width="100px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="SFTClosingStock" HeaderText="SFT Closing Stock">
                                <ItemStyle HorizontalAlign="Center" Width="100px" />
                                </asp:BoundField>
                                 <asp:BoundField DataField="SQMClosingStock" HeaderText="SQM Closing Stock">
                                <ItemStyle HorizontalAlign="Center" Width="100px" />
                                </asp:BoundField>
