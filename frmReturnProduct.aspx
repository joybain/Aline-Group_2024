<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmReturnProduct.aspx.cs" Inherits="frmReturnProduct" %>
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="width: 18%; height: 23px;">
                                                        <asp:TextBox ID="txtInvoiceNo" runat="server" Width="98%" Enabled="False"></asp:TextBox>
                                                    </td>
                                                     <td  style="width: 12%; height: 23px;" align="right">
                                                         Project Site</td>
                                                    <td style="width: 3%; color: #FF0000; height: 23px;" align="center">
                                                    ...
                                                    <td style="width: 18%; height: 23px;">
                                                        <asp:TextBox ID="txtSite" runat="server" Enabled="False" Width="98%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="right" style="width: 12%; height: 23px;">
                                                        <asp:Label ID="Label8" runat="server" Text="Costing Date"></asp:Label>
                                                    </td>
                                                    <td align="center" style="width: 3%; color: #FF0000; height: 23px;">
                                                        *</td>
                                                    <td style="width: 18%; height: 23px;">
                                                        <asp:TextBox ID="txtCostDate" runat="server" Width="98%"></asp:TextBox>
                                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" 
                                                            Enabled="True" Format="dd/MM/yyyy" TargetControlID="txtCostDate">
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="width: 50%">
                                                        ...
                                                        <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender4" runat="server" 
                                                            ...
                                                            Enabled="True" MinimumPrefixLength="1" ServiceMethod="GetItemCostProjectReturn" 
                                                ...
                                                <asp:GridView ID="dgPODetailsDtl" runat="server" AutoGenerateColumns="False" 
                                                    BorderColor="LightGray" CssClass="mGrid" Font-Size="9pt" 
                                                     Width="100%"  
                                                     AllowPaging="True" 
                                                     PageSize="20" onrowdatabound="dgPODetailsDtl_RowDataBound" onrowdeleting="dgPODetailsDtl_RowDeleting" 
                                                    >
                                                     ...
                                                     <asp:BoundField DataField="ItemId" HeaderText="ItemID" />
                                                        ...
                                                        <asp:BoundField DataField="Uom" HeaderText="UOM" />
                                                         <asp:BoundField DataField="UomId" HeaderText="UOMId" />
                                                           <asp:TemplateField HeaderText="Cost Quantity">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtcostQnty" runat="server" CssClass="tbc" 
                                                                    Font-Size="8pt" onFocus="this.select()" 
                                                                    SkinId="tbPlain" Text='<%#Eval("costqnty")%>' Width="93%" Enabled="False" ReadOnly="True"  
                                                                    ></asp:TextBox>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Return Quantity">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtQnty" runat="server"  AutoPostBack="true" CssClass="tbc" 
                                                                    Font-Size="8pt" onFocus="this.select()" 
                                                                    SkinId="tbPlain" Text='<%#Eval("qnty")%>' Width="93%" ontextchanged="txtQnty_TextChanged" 
                                                                    ></asp:TextBox>
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                                                        </asp:TemplateField>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <asp:Button ID="btnView" runat="server" BorderStyle="Outset" Height="35px" 
                                                            Text="Print" Width="110px" onclick="btnView_Click" />
                                                    </td>
                                                    <td align="center">
                                                    ...
                                                    <td align="center">
                                                        <asp:Button ID="btnReturn" runat="server" BorderStyle="Outset" Height="35px" 
                                                             Text="Return" ToolTip="Save Purchase Record" 
                                                            Width="110px"  onclick="btnSaveReturn_Click" />
                                                    </td>
                                                     <td align="center">
                                                        <asp:Button ID="btnUpdate" runat="server" BorderStyle="Outset" Height="35px" 
                                                             Text="Update Return" ToolTip="Save Purchase Record" 
                                                            Width="110px"  onclick="btnUpdateReturn_Click" />
                                                     </td>
                                                    <td align="center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 15%">
                                                            <asp:Button ID="btnSearch" runat="server" BorderStyle="Outset" Height="25px" 
                                                                 Text="Search" ToolTip="Authorize"  OnClick="btnSearchOnclick"  Width="100px" 
                                                                />
                                                        </td>
                                                        <td style="width: 10%">
                                        ...
                                        <td style="width: 90%">
                                            <fieldset style="vertical-align: top; border: solid 1px #8BB381;">
                                                ...
                                                <asp:GridView ID="dgHistory" runat="server" AutoGenerateColumns="False" 
                                                    ...
                                                    Width="100%" 
                                                     AllowPaging="True" 
                                                     PageSize="20"  onrowdatabound="dgPODetailsDtl_RowDataBoundHistory" onselectedindexchanged="dgHistory_SelectedIndexChanged"  
                                                    >
                                                    <AlternatingRowStyle CssClass="alt" />
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="CostCode" HeaderText="Return Code" >
                                                        <ItemStyle HorizontalAlign="Center" Width="25%" /></asp:BoundField>
                                                        
                                                       
                                                        <asp:BoundField DataField="CostingDate" HeaderText="Return Date" >
                                                        <ItemStyle HorizontalAlign="Center" Width="15%" /></asp:BoundField>
                                                        <asp:BoundField DataField="TotalQuntity" HeaderText="Return Quantity" >
                                                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Projectid" HeaderText="Project Name" >
