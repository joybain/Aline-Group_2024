...
<table id="Table1" style="width:93%;">
	<tr >
    ...
    <tr >
	<td style="width: 13%; " align="left">
    <asp:Label ID="LblSuppNo" runat="server" Font-Size="9pt" >Compeny</asp:Label></td>
	<td style="width: 30%; " align="left">
	...
	<td style="width: 30%; " align="left">
     ...
     <tr >
	<td style="width: 13%; " align="left">
    <asp:Label ID="Label1" runat="server" Font-Size="9pt" >Supplier Name</asp:Label></td>
	<td style="width: 30%; " align="left">
    <asp:TextBox SkinId="tbPlain" ID="txtSupliarName" runat="server" Width="90%" style="text-align:left;"
            CssClass="tbc"  AutoPostBack="False"  Font-Size="8pt"></asp:TextBox>
    </td>
    <td style=" width:5%;" align="left">
	...
	<td style="width: 15%; " align="left">
	<asp:Label ID="Label6" runat="server" Font-Size="9pt">Supplier Phone</asp:Label></td>
	<td style="width: 30%; " align="left">
  <asp:TextBox SkinId="tbPlain" ID="txtSupplierPhone" runat="server" Width="95%" style="text-align:left;"
    ...
    <td style="width: 13%; " align="left">
    <asp:Label ID="Label5" runat="server" Font-Size="9pt" Visible="False" >Exp. Delivery Date</asp:Label>
    </td>
    <td style="width: 30%;" align="left">
    <asp:TextBox SkinId="tbPlain" ID="txtDelDate" runat="server" Width="40%" style="text-align:center;"
            CssClass="tbc"  AutoPostBack="False"  Font-Size="8pt" Visible="False"></asp:TextBox>
    ...
    <td style="width: 15%; " align="left">
    <asp:Label ID="lblPhnNo" runat="server" Font-Size="9pt" Visible="False" >Order Status</asp:Label>
    </td>
    <td style="width: 30%; " align="left">
    <asp:DropDownList SkinId="ddlPlain" ID="ddlReqStatus" runat="server" 
            Font-Size="8pt" Width="43%" Height="26px" Enabled="false" Visible="False" >
   ...
   <tr>
        ...
        <td align="left" style="width: 13%; ">
         ...
         <asp:Label ID="Label9" runat="server" Font-Size="9pt" >Project</asp:Label>
        </td>
           
        <td align="left" style="width: 30%;">
             <asp:DropDownList ID="ddlProject" runat="server" Width="93%" Enabled="False" 
        ...
        <asp:Label ID="Label10" runat="server" Font-Size="9pt" >Site</asp:Label>
        </td>
           
        <td align="left" style="width: 30%; ">
         <asp:TextBox ID="txtSite" runat="server" Width="95%" Enabled="False" 
     ...
     <tr>
        ...
        <td align="left" style="width: 13%; ">
        <asp:Label ID="lblReqNo" runat="server" Visible="false" Font-Size="9pt" ></asp:Label>
         <asp:Label ID="Label7" runat="server" Font-Size="9pt" >Req No :</asp:Label>
        </td>
           
        <td align="left" style="width: 30%;">
        <asp:TextBox ID="txtRqNo" runat="server" AutoPostBack="True" CssClass="tbc" 
                    Font-Size="8pt" ontextchanged="txtRqNo_TextChanged" SkinId="tbPlain" 
                    style="text-align:center;" Width="90%"></asp:TextBox>
                <cc:AutoCompleteExtender ID="autoComplete1" runat="server" 
                    CompletionInterval="10" CompletionSetCount="12" EnableCaching="true" 
                    MinimumPrefixLength="1" ServiceMethod="GetRequisitionList" 
                    ServicePath="AutoComplete.asmx" TargetControlID="txtRqNo" />            
           </td>
        <td style=" width:5%;">
            &nbsp;</td>
        <td align="left" style="width: 15%; ">
        <asp:Label ID="Label2" runat="server" Font-Size="9pt" >CS No :</asp:Label>
        </td>
           
        <td align="left" style="width: 30%; ">
        <asp:TextBox SkinId="tbPlain" ID="txtCSNo" runat="server" Width="95%" style="text-align:center;"
            CssClass="tbc"  AutoPostBack="False"  Font-Size="8pt" ></asp:TextBox>
            &nbsp;</td>
    </tr>    
                         ...
                         <asp:TemplateField HeaderText="Item Code">
                             <ItemTemplate>
                                 <asp:TextBox ID="txtItemCode" runat="server" 
                                     AutoPostBack="true" Font-Size="8pt" MaxLength="15" 
                         ...
                         <asp:TemplateField HeaderText="Item Rate">
                             <ItemTemplate>
                                 <asp:TextBox ID="txtItemRate" runat="server" 
                                     AutoPostBack="True" CssClass="tbr" Font-Size="8pt" onkeypress="return isNumber(event)"
           SkinId="tbPlain" Text='<%#Eval("item_rate")%>' Width="93%" onFocus="this.select()" 
                                     OnTextChanged="txtItemRate_TextChanged"></asp:TextBox></ItemTemplate><ItemStyle HorizontalAlign="Right" Width="10%" /></asp:TemplateField>
