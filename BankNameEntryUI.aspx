<%--<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BankNameEntryUI.aspx.cs" Inherits="ACCWebApplication.BankNameEntryUI" %>--%>
 <%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="BankNameEntryUI.aspx.cs" Inherits="BankNameEntryUI" Title="Untitled Page" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<table style="width:100%; height:700px;">
        <tr>
            <td  colspan="2" style="height:40px; text-align:center;">
                <h2>
                    <strong>Bank Information</strong></h2>
            </td>
        </tr>
        <tr>
            <td align="right" style="height:40px; width:50%;"  class="style1">
                Bank Id :</td>
            <td height="20">
                <asp:TextBox ID="BankIdTextBox" runat="server" Enabled="False" 
        ...
        <tr>
            <td align="right" style="height:40px;" class="style1">
                Bank Name :</td>
            <td>
                <asp:TextBox ID="BankNameTextBox" runat="server" Height="30px" 
        ...
        <tr>
            <td style="height:400px;" colspan="2" valign="top" align="center">
                <asp:GridView ID="BankGridView" runat="server" 
                    AutoGenerateColumns="False" Width="80%" AllowPaging="True" PageSize="23" 
                    onselectedindexchanged="BankGridView_SelectedIndexChanged">
                    <Columns>
                        <asp:BoundField DataField="bnk_id" HeaderText="Bank Id" 
                            SortExpression="bnk_id" />
