...
<div>
    ...
    <fieldset style="vertical-align: top; border: solid 1px #8BB381;text-align:left;"><legend style="color: maroon;"><b>Search Items</b> </legend>
        <table class="style1">
           ...
           ServiceMethod="GetShowStockItems" MinimumPrefixLength="1" CompletionInterval="1000" EnableCaching="true" 
...
<ItemStyle HorizontalAlign="Left" Height="20px" Width="300px"></ItemStyle>
                </asp:BoundField>
