...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <script language="javascript" type="text/javascript" >
        ...
        function TotSumation() {
            ...
            var todD = parseFloat(txtSubTotal.value) - ((parseFloat(txtSubTotal.value) * parseFloat(txtDiscount.value)) / 100);
            var totv = parseFloat(todD) + ((parseFloat(todD) * parseFloat(txtVat.value)) / 100);
            txtPayment.value = totv.toFixed(2);
        ...
        function Due() {
            ...
            //            var todD = parseFloat(txtSubTotal.value) - ((parseFloat(txtSubTotal.value) * parseFloat(txtDiscount.value)) / 100);
            //            var totv = parseFloat(todD) + ((parseFloat(todD) * parseFloat(txtVat.value)) / 100);
            //            if (parseFloat(txtDue) < parseFloat(txtPayment.value)) {
            //                alert("Payment Amount Over This Total Charge.....!!!! ");
            //                txtTotPayment.value = "0";
            //                txtTotPayment.focus();
            //            }
            //            else {
            //                var tt = parseFloat(totv) - parseFloat(txtPayment.value)
...
<td style="width:62%; height: 3px;">
                <asp:Label ID="lblInvNo" runat="server" Visible="False"></asp:Label> <asp:HiddenField ID="hfOutTime" runat="server" />
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td align="left" style="width: 124px">
               <asp:Label ID="Label9" runat="server" Font-Size="9pt">Order No</asp:Label></td>
            <td align="left" style="width: 346px">
                
                  <asp:TextBox SkinId="tbPlain" ID="txtSO" runat="server" Width="94%" 
                      CssClass="tbc" placeholder="Search SO. No" TabIndex="3"
            Font-Size="8pt" ontextchanged="txtSO_TextChanged" AutoPostBack="True" Height="20px"></asp:TextBox>
            <ajaxtoolkit:AutoCompleteExtender ID="txtSO_AutoCompleteExtender"
                                                        runat="server" CompletionInterval="20" CompletionSetCount="30"
                                                        EnableCaching="true" MinimumPrefixLength="2"
                                                        ServiceMethod="GetShowSONo" ServicePath="~/AutoComplete.asmx"
                                                        TargetControlID="txtSO">
...
<td align="center" colspan="2"> 
      ...
      <table style="width: 100%">
            <tr>
                <td style="width: 10%; height: 26px; text-align: right;">
                <asp:Label ID="Label40" runat="server" Text="Driver Name"></asp:Label>
                </td>
                <td style="width: 2%; height: 26px;">:</td>
                 <td style="width: 22%; height: 26px; text-align: left;">
                     <asp:TextBox ID="txtDriverName" runat="server" Width="100%"></asp:TextBox>
                </td>
                 
                  <td style="width: 10%; height: 26px; text-align: right;">
                <asp:Label ID="Label41" runat="server" Text="Phone No"></asp:Label>
                </td>
                <td style="width: 2%; height: 26px;">:</td>
                 <td style="width: 22%; height: 26px; text-align: left;">
                     <asp:TextBox ID="txtDriverPhoneNo" runat="server" Width="100%"></asp:TextBox>
                </td>
                
                 <td style="width: 10%; height: 26px; text-align: right;">
                <asp:Label ID="Label5" runat="server" Text="Car No"></asp:Label>
                </td>
                <td style="width: 2%; height: 26px;">:</td>
                 <td style="width: 22%; height: 26px; text-align: left;">
                     <asp:TextBox ID="txtCarNo" runat="server" Width="100%"></asp:TextBox>
                </td>
            </tr>
             ...
             <td align="center">
                 <table style="width: 100%">                
                     <tr>
                      ...
                      Font-Size="8pt"  SelectedValue='<%#Eval("msr_unit_code")%>' SkinId="ddlPlain" 
                        Width="95%" Height="26px" TabIndex="100" 
                                         onselectedindexchanged="ddlMeasure_SelectedIndexChanged">
                      <asp:ListItem Value="C">CFT</asp:ListItem>
                      <asp:ListItem Value="R">Rol</asp:ListItem>
                </asp:DropDownList>
                ...
                SelectedValue='<%#Eval("msr_unit_code")%>'  SkinId="ddlPlain" 
                        Width="95%" Height="26px" TabIndex="100" onselectedindexchanged="ddlMeasure_SelectedIndexChanged">
                </asp:DropDownList>
                ...
                <ItemStyle HorizontalAlign="Center" Width="8%" />
                                     ...
                                     <asp:TemplateField HeaderText="Pack Size">
                                         <ItemTemplate>
                                             <asp:TextBox ID="txtPackSize" runat="server" 
                                                 onfocus="this.select();"  
                                                 style="text-align:center;" Text='<%# Eval("PackSize") %>' Width="92%" 
                                                 ontextchanged="txtPackSize_TextChanged"></asp:TextBox>
                                         </ItemTemplate>
                                         <ItemStyle Height="20px" Width="60px" />
                                     </asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="ClosingStock" HeaderText="Stock/Roll">
                                     <HeaderStyle Height="20px" Width="60px" />
                                     <ItemStyle Height="20px" HorizontalAlign="Right" Width="100px" />
                                     </asp:BoundField>
                                     <asp:BoundField DataField="SalesClosingStock" HeaderText="Stock/CFT" >
                                     <ItemStyle Height="20px" HorizontalAlign="Right" Width="60px" />
                                     </asp:BoundField>
                                     <asp:BoundField DataField="SftClosingStock" HeaderText="Stock/SFT">
                                     <ItemStyle Height="20px" HorizontalAlign="Right" Width="60px" />
                                     </asp:BoundField>
                                     <asp:BoundField DataField="SqmClosingStock" HeaderText="Stock/SQM">
                                     <ItemStyle Height="20px" HorizontalAlign="Right" Width="60px" />
                                     </asp:BoundField>
        ...
        <tr>
           ...
           <ContentTemplate>  
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td align="right" style="height: 24px">
                            <asp:TextBox ID="txtVat" runat="server" align="right"  TabIndex="5"
                                style="text-align:right;" Width="100px" AutoPostBack="True" 
                ...
                TargetControlID="txtDeleveryDate" Format="dd/MM/yyyy"/>
                        ...
                        <td style="height: 20px" align="right">
                            <asp:TextBox ID="txtDiscount" runat="server" style="text-align:right;" 
                               onfocus="this.select();" TabIndex="6"
                                Width="100px" AutoPostBack="True" ontextchanged="txtDiscount_TextChanged1"></asp:TextBox>
                        </td>
                    </tr>
                        ...
                        <td style="height: 20px" align="right">
                  <asp:TextBox ID="txtGrandTotal" runat="server" style="text-align:right;" 
                               onfocus="this.select();" TabIndex="6" onkeypress="return isNumber(event)"
                    ...
                    <tr>
                        ...
                        <td style="width: 278px" align="left" rowspan="3" valign="top">
                        ...
                        <td align="right" style="height: 15px">
                          <asp:TextBox ID="txtPayment" runat="server" Width="100px" 
                                style="text-align:right;"  onChange="Due();" onfocus="this.select();" 
                                TabIndex="7" AutoPostBack="True" ontextchanged="txtPayment_TextChanged"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
