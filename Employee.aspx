<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Employee.aspx.cs" Inherits="Employee" Title="Personnel Information"  Theme="Themes" MaintainScrollPositionOnPostback="true"%>
...
<tr>
  <td style="width: 15%; height: 27px;" align="left"><asp:Label ID="lblEmpNo" 
          runat="server" Font-Size="8pt">Employee Id </asp:Label>
      <span style="color: #FF0000">*</span></td>
	<td style="width: 16%; height: 27px;" align="left">
        <asp:TextBox SkinID="tbGray" ID="txtEmpNo"  CssClass="tbc"
	...
	<td style="width:3%;"></td>
	<td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label22" runat="server" Font-Size="8pt" Width="100px">National ID</asp:Label>
      <span style="color: #FF0000">*</span></td>
	<td style="width: 16%; height: 27px;" align="left">
        <asp:TextBox SkinID="tbGray" ID="txtNationalId"  CssClass="tbc"
            runat="server" Width="100%" AutoPostBack="False"  Enabled="true"
            Font-Size="8pt" MaxLength="20"></asp:TextBox> </td> 
</tr>
<tr>
  <td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label1" 
          runat="server" Font-Size="8pt">Name :</asp:Label>
      <asp:Label ID="lblID" 
          runat="server" Font-Size="8pt" Visible="False"></asp:Label>
      <span style="color: #FF0000">*</span></td>
...
<tr>
  <td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label16" runat="server" Font-Size="8pt" Width="100px">Sex</asp:Label></td>
	<td style="width: 16%; height: 27px;" align="left">
	...
	<td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label17" 
            runat="server" Font-Size="8pt">DOB</asp:Label>
      <span style="color: #FF0000">*</span></td>
	<td style="width: 16%; height: 27px;" align="left">
...
<tr>
  <td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label19" runat="server" Font-Size="8pt" Width="100px">Religion</asp:Label></td>
	<td style="width: 16%; height: 27px;" align="left">
...
<tr>
  <td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label13" 
          runat="server" Font-Size="8pt">Father Name</asp:Label>
      <span style="color: #FF0000">*</span></td>
  ...
  <td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label9" runat="server" Font-Size="8pt" Width="100px">Employee Type :</asp:Label></td>
	...
	<asp:DropDownList SkinID="ddlPlain" ID="ddlEmpCat" runat="server" Font-Size="8pt" Width="105%" Height="18px" >
     <asp:ListItem></asp:ListItem>  
     <asp:ListItem Text="Desk" Value="D"></asp:ListItem>     
     <asp:ListItem Text="Marketing" Value="M"></asp:ListItem> 
     <asp:ListItem Text="D&amp;M" Value="DM"></asp:ListItem>
     </asp:DropDownList> </td>          
</tr>
<tr>	
    ...
    <td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label4" 
            runat="server" Font-Size="8pt">Date of Join</asp:Label>
      <span style="color: #FF0000">*</span></td>
	<td style="width: 16%; height: 27px;" align="left">
...
<tr>     	
	<td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label5" 
            runat="server" Font-Size="8pt">Designation </asp:Label>
      <span style="color: #FF0000">*</span></td>
	<td style="width: 50%; height: 27px;" align="left" colspan="4">
     ...
     <td style="width:3%;"></td>
    <td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label6" 
            runat="server" Font-Size="8pt">Job Status</asp:Label>
      <span style="color: #FF0000">*</span></td>
	<td style="width: 16%; height: 27px;" align="left">
...
<tr>	
	<td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label35" runat="server" Font-Size="8pt" Width="100px">Passport No</asp:Label></td>
	<td style="width: 16%; height: 27px;" align="left">
    <asp:TextBox SkinID="tbGray" ID="txtPassNo"  CssClass="tbc"
            runat="server" Width="100%" AutoPostBack="False"  Enabled="true"
            Font-Size="8pt" MaxLength="20"></asp:TextBox></td>        
    <td style="width:3%;"></td>
  <td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label37" runat="server" Font-Size="8pt" Width="100px">Driving Licnse No</asp:Label></td>
	<td style="width: 16%; height: 27px;" align="left">
	...
	<td style="width: 15%; height: 27px;" align="left">
        <asp:Label ID="Label44" 
            runat="server" Font-Size="8pt">Retirment Date</asp:Label>
      </td>
	<td style="width: 16%; height: 27px;" align="left">    
        <asp:TextBox SkinID="tbGray" ID="txtRetirmentDate"  CssClass="tbc" PlaceHolder="dd/MM/yyyy"
            runat="server" Width="100%" AutoPostBack="false" Font-Size="8pt" 
            MaxLength="11" ></asp:TextBox>
    <ajaxtoolkit:calendarextender runat="server" ID="txtConfirmDate0_calendarextender" 
            TargetControlID="txtRetirmentDate" Format="dd/MM/yyyy"/>
            </td>        
</tr>
<tr>	
	<td style="width: 15%; height: 27px;" align="left">Total Salary</td>
	<td style="width: 16%; height: 27px;" align="left">
    <asp:TextBox SkinID="tbGray" ID="txtBasicSalary"  CssClass="tbc"
            runat="server" Width="100%" AutoPostBack="False"  Enabled="true"
            Font-Size="8pt" MaxLength="20"></asp:TextBox></td>        
    <td style="width:3%;">&nbsp;</td>
  <td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label42" 
          runat="server" Font-Size="8pt" Width="100px">Segment Code</asp:Label></td>
	<td style="width: 16%; height: 27px;" align="left">
<asp:TextBox SkinID="tbPlain" ID="txtGlCoa" style="text-align:left;" 
	...
	<td style="width: 15%; height: 27px;" align="left">
        <asp:Label ID="Label45" 
            runat="server" Font-Size="8pt">Pension Amount</asp:Label>
      </td>
	<td style="width: 16%; height: 27px;" align="left">    
    <asp:TextBox SkinID="tbGray" ID="txtPensionamount"  CssClass="tbc"
            runat="server" Width="100%" AutoPostBack="False"  Enabled="true"
            Font-Size="8pt" MaxLength="20"></asp:TextBox></td>        
</tr>
<tr>	
	<td style="width: 15%; height: 27px;" align="left">
      ...
      <span style="color: #FF0000">*</span></td>
	<td style="width: 16%; height: 27px;" align="left">
        <asp:DropDownList ID="ddlCountry" runat="server" Height="26px" Width="150px">
        </asp:DropDownList>
            </td>        
    <td style="width:3%;">&nbsp;</td>
  <td style="width: 15%; height: 27px;" align="left"><asp:Label ID="Label38" runat="server" Font-Size="8pt" Width="100px">PF No</asp:Label></td>
	<td style="width: 16%; height: 27px;" align="left">
    <asp:TextBox SkinID="tbGray" ID="txtPfNo"  CssClass="tbc"
            runat="server" Width="100%" AutoPostBack="False"  Enabled="true"
            Font-Size="8pt" MaxLength="15"></asp:TextBox>
                            </td>
	<td style="width:3%;">&nbsp;</td>
	<td style="width: 15%; height: 27px;" align="left">
        &nbsp;</td>
...
<tr>
<td colspan="6"><asp:Label ID="lblTranStatus" runat="server" Font-Size="8pt" Text="" Visible="false"></asp:Label></td>
</tr>
</table>
<%--</ContentTemplate>
</asp:UpdatePanel>--%>
...
<ajaxtoolkit:TabPanel ID="tab" runat="server" HeaderText="Employee General Info" Visible="True">                    
<ContentTemplate>
...
<tr>    
	...
	<td style="width: 10%; height: 30px;" align="right"><asp:Label ID="Label36" 
            runat="server" Font-Size="8pt">Present Desig</asp:Label>
        <span style="color: #FF0000">*</span></td>
	<td style="width: 36%; height: 30px;" align="left" colspan="3">
...
<tr>
<td style="width: 10%; height: 30px;" align="right"><asp:Label ID="Label11" 
        runat="server" Font-Size="8pt" Width="100px" Visible="False">Present Branch</asp:Label>
    </td>
	<td style="width: 36%; height: 30px;" align="left" colspan="3">
	<asp:DropDownList SkinID="ddlPlain" ID="ddlBranchKey" runat="server" 
            Font-Size="8pt" Width="102%" Height="18px" Visible="False" >
        </asp:DropDownList></td>  
...
<ajaxtoolkit:TabPanel ID="TabPanel1" runat="server" HeaderText="Education" Visible="True">                    
<ContentTemplate>
<table style="width:100%; font-size:8pt;">
<tr>
...
<asp:GridView CssClass="mGrid" ID="dgEmpEdu" runat="server" AutoGenerateColumns="False" 
  ...
  <EditItemTemplate>
  <asp:TextBox SkinID="tbGray" ID="txtGroupName" 
  ...
  <asp:TextBox SkinID="tbGray" ID="txtInstitute" 
            runat="server" Width="150px" TabIndex="63" Font-Size="8pt" MaxLength="50"></asp:TextBox>
      </EditItemTemplate>
  <FooterTemplate>
  <asp:TextBox SkinID="tbGray" ID="txtInstitute" 
            runat="server" Width="150px" TabIndex="63" Font-Size="8pt" MaxLength="50"></asp:TextBox>
  ...
  <asp:TextBox SkinID="tbGray" ID="txtPassYear" 
            runat="server" Width="60px" TabIndex="64" Font-Size="8pt" MaxLength="4"></asp:TextBox>
      </EditItemTemplate>
  <FooterTemplate>
  <asp:TextBox SkinID="tbGray" ID="txtPassYear" 
            runat="server" Width="60px" TabIndex="64" Font-Size="8pt" MaxLength="4"></asp:TextBox>
...
<ajaxtoolkit:calendarextender runat="server" ID="CalendarextenderBirthDate1" TargetControlID="txtBirthDt" Format="dd/MM/yyyy"/>
  ...
  <asp:TextBox SkinID="tbGray" ID="txtAge" 
            runat="server" Width="80px" TabIndex="74" Font-Size="8pt" MaxLength="2"></asp:TextBox>
      </EditItemTemplate>
  <FooterTemplate>
  <asp:TextBox SkinID="tbGray" ID="txtAge" 
            runat="server" Width="80px" TabIndex="74" Font-Size="8pt" MaxLength="2"></asp:TextBox>
  ...
  <asp:TextBox SkinID="tbGray" ID="txtOccupation" 
            runat="server" Width="150px" TabIndex="75" Font-Size="8pt" MaxLength="40"></asp:TextBox>
      </EditItemTemplate>
  <FooterTemplate>
  <asp:TextBox SkinID="tbGray" ID="txtOccupation" 
            runat="server" Width="150px" TabIndex="75" Font-Size="8pt" MaxLength="40"></asp:TextBox>
...
<asp:GridView CssClass="mGrid" ID="dgEmpTrans" runat="server" AutoGenerateColumns="False" 
  ...
  <ItemTemplate>
  <asp:Label ID="lblBranchCode" runat="server" Text='<%#Eval("BranchName") %>' Width="150px"></asp:Label>  
      </ItemTemplate>
  <EditItemTemplate>
  ...
  <ItemTemplate>
  <asp:Label ID="lblDesigCode" runat="server" Text='<%#Eval("desig_Name") %>' Width="150px"></asp:Label>  
      </ItemTemplate>
  <EditItemTemplate>
...
<asp:GridView CssClass="mGrid" PagerStyle-CssClass="pgr"  AlternatingRowStyle-CssClass="alt" ID="dgEmpProm" runat="server" AutoGenerateColumns="False" 
  ...
  <asp:TemplateField HeaderText="Branch">
  <ItemTemplate>
  <asp:Label ID="lblJoiningBranch" runat="server" Text='<%#Eval("joining_branchName") %>' Width="150px" Font-Size="8pt"></asp:Label>  
      </ItemTemplate>
  <EditItemTemplate>
  ...
  <asp:TemplateField HeaderText="Designation">
  <ItemTemplate>
  <asp:Label ID="lblJoiningDesig" runat="server" Text='<%#Eval("joining_desigName") %>' Width="150px" Font-Size="8pt"></asp:Label>  
      </ItemTemplate>
  <EditItemTemplate>
...
<%--<ajaxtoolkit:TabPanel ID="TabPanel8" runat="server" HeaderText="Quarter">                    
<ContentTemplate>
<table style="width:100%; font-size:8pt;">
<tr><td style="font-size:8pt;" align="left">
    &nbsp;</td></tr>
...
<ContentTemplate>
  ...
  <asp:CommandField ShowSelectButton="True">
      ...
      <asp:BoundField DataField="EMP_BIRTH_DT" HeaderText="Date Of Birth " 
          SortExpression="EMP_BIRTH_DT" />
      <asp:BoundField DataField="RELIGION_CODE" HeaderText="Religion" 
          SortExpression="RELIGION_CODE" />
