                    ...
                    <tr>
                        <td style="width: 35%" valign="top">
                            ...
                            <asp:RadioButtonList ID="rdbReportType" runat="server" 
                                ...
                                <asp:ListItem  Value="PWR">Project Wish Report</asp:ListItem>
                                <asp:ListItem Value="Os">Opration Summery</asp:ListItem>
                            </asp:RadioButtonList>
                  </fieldset>
                        </td>
                                ...
                                <tr>
                                    <td align="left" valign="top" style="margin-left: 80px">
                                      ...
                                      <fieldset style="vertical-align: top; border: solid 1px #8BB381;text-align:left;"><legend style="color: maroon;">
                                        ...
                                        <asp:Panel ID="pnlProjectWish" runat="server">
                                        <fieldset style="vertical-align: top; border: solid 1px #8BB381;text-align:left;"><legend style="color: maroon;">Report Paremeter</legend>
                                            <table style="width: 100%; margin-left: 0px;">
                                                <tr>
                                                    ...
                                                    <td align="right" colspan="2" style="height: 22px;">
                                                        &nbsp;</td>
                                                    <td style="width: 25%; height: 22px;">
                                                        <asp:Label ID="lblProjectNameId" runat="server" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" style="width: 16%; font-size: xx-small; height: 27px;">
                                                        Project Name</td>
                                                    <td align="center" style="width: 5%; height: 27px; font-weight: 700;">
                                                        &nbsp;</td>
                                                    <td colspan="4" style="height: 27px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" style="width: 5%; height: 27px; font-weight: 700;">
                                                        &nbsp;</td>
                                                    <td style="width: 25%; height: 27px;">
                                                        <asp:TextBox ID="txtFromDatePWS" runat="server" placeHolder="dd/MM/yyyy" 
                                                            Width="90%"></asp:TextBox>
                                                        <ajaxToolkit:CalendarExtender ID="txtFromDateITS0_CalendarExtender" 
                                                            runat="server" Enabled="True" Format="dd/MM/yyyy" 
                                                            TargetControlID="txtFromDatePWS">
                                                        </ajaxToolkit:CalendarExtender>
                                                    </td>
                                                    <td align="right" style="width: 15%; height: 27px;">
                                                        <asp:Label ID="Label15" runat="server" Text=" Date To"></asp:Label>
                                                    </td>
                                                    <td align="center" style="width: 5%; height: 27px; font-weight: 700;">
                                                        &nbsp;</td>
                                                    <td style="width: 25%; height: 27px;">
                                                        <asp:TextBox ID="txtToDatePWS" runat="server" placeHolder="dd/MM/yyyy" 
                                                            Width="89%"></asp:TextBox>
                                                        <ajaxToolkit:CalendarExtender ID="txtToDateITS0_CalendarExtender" 
                                                            runat="server" Enabled="True" Format="dd/MM/yyyy" 
                                                            TargetControlID="txtToDatePWS">
                                                        </ajaxToolkit:CalendarExtender>
                                                    </td>
                                                </tr>
                                            </table>  </fieldset>
