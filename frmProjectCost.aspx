<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmProjectCost.aspx.cs" Inherits="frmProjectCost" %>
                                            ...
                                            <table style="width: 100%">
                                                ...
                                                <ItemStyle HorizontalAlign="Center" Width="8%" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Floor">
                                                            <ItemTemplate>
                                                                    <asp:TextBox ID="txtFloor" runat="server" AutoPostBack="true" CssClass="tbc" 
                                                                    Font-Size="8pt" onFocus="this.select()" 
                                                                    SkinId="tbPlain" Text='<%#Eval("floor")%>' ontextchanged="txtFloor_TextChanged" 
                                                                    ></asp:TextBox>
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Center" Width="8%" />
                                                        </asp:TemplateField>
                                                         ...
                                                         <asp:TemplateField HeaderText="Stage">
                                                            <ItemTemplate>
                                                                  <asp:TextBox ID="txtstage" runat="server"  CssClass="tbc" 
                                                                    Font-Size="8pt" onFocus="this.select()" 
                                                                    SkinId="tbPlain" Text='<%#Eval("stage")%>'
                                                                      ontextchanged="txtstage_TextChanged" AutoPostBack="True"  
                                                                    ></asp:TextBox>
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Center" Width="8%" />
                                                        </asp:TemplateField>
                                                       ...
                                                       <asp:TemplateField HeaderText="Remarks">
                                                            <ItemTemplate>
                                                                  <asp:TextBox ID="txtRemarks" runat="server"  CssClass="tbc" 
                                                                    Font-Size="8pt" onFocus="this.select()" 
                                                                    SkinId="tbPlain" Text='<%#Eval("Remarks")%>'
                                                                      ontextchanged="txtRemarks_TextChanged" AutoPostBack="True" 
                                                                    ></asp:TextBox>
                                                            </ItemTemplate>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <asp:Button ID="btnSaveLost" runat="server" BorderStyle="Outset" Height="35px" 
                                                            ...
                                                            Width="110px" onclick="btnSaveLost_Click" />
                                                    </td>
                                                    <td align="center">
                                                        <asp:Button ID="btnUpdate" runat="server" BorderStyle="Outset" Height="35px" 
                                                             Text="Update" ToolTip="Save Purchase Record" 
                                                            Width="110px" onclick="btnUpdateLost_Click" />
                                                    </td>
                                                    <td align="center">
                                        ...
                                        <td style="width: 90%">
                                            <fieldset style="vertical-align: top; border: solid 1px #8BB381;">
                                                ...
                                                <asp:GridView ID="dgHistory" runat="server" AutoGenerateColumns="False" 
                                                    ...
                                                    Width="100%" 
                                                     AllowPaging="True" 
                                                     PageSize="20" onselectedindexchanged="dgHistory_SelectedIndexChanged" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="CostingDate" HeaderText="Cost Date" >
                                                        <ItemStyle HorizontalAlign="Center" Width="15%" /></asp:BoundField>
                                                        <asp:BoundField DataField="TotalQuntity" HeaderText="Total Quantity" >
                                                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                                                        </asp:BoundField>
