...
public partial class PurchaseVoucher : System.Web.UI.Page
{
    ...
    protected void btnNew_Click(object sender, EventArgs e)
    {
      ...
      //  txtGRNO.Text = IdManager.GetDateTimeWiseSerial("GRN", "GRN", "[ItemPurchaseMst]");
        txtGRNO.Text = IdManager.GetDateTimeWiseSerial("GN", "GRN", "[ItemPurchaseMst]");
    ...
    {
        ViewState["GlCode"] = IdManager.GetShowSingleValueString("Gl_Code", "bank_id", "bank_info", ddlBank.SelectedValue);
    }
               ...
               // if (Convert.ToDecimal(lblCashValue.Text) > Convert.ToDecimal(txtTotPayment.Text.Replace(",", "")))
                {
                    ...
                    if (purmst != null)
                    {
                        if (per.AllowEdit == "Y")
                        {
                            ...
                            purmst.ProjectId = ddlProject.SelectedValue;
                            purmst.ProjectSite = txtSite.Text;
                            ...
                            purmst.Discount = txtDiscountAmount.Text.Replace(",", "");
                    ...
                    else
                    {
                        if (per.AllowAdd == "Y")
                        {
                            ...
                            int ID = PurchaseVoucherManager.SavePurchaseVoucher(purmst, dt,lblRequtionId.Text, lblOrNo.Text, ViewState["GlCode"].ToString());
    ...
    {
        Response.Redirect("PurchaseVoucher.aspx?mno=1.8");
        //RefreshAll();
    }
    ...
    private void ShowFooterTotal()
    {
        ...
        txtGrandTotal.Text = Total.ToString("N0").Replace(",", "");
  ...
  //*************************  txtQnty_TextChanged *******************//
    ...
    protected void txtPO_TextChanged(object sender, EventArgs e)
    {
        ...
        {   
            ...
            Session["Supplier_COA"] = IdManager.GetShowSingleValueString("Gl_CoaCode", "ID", "Supplier", ddlSupplier.SelectedValue);
            lblRequtionId.Text = dt.Rows[0]["RequisitionId"].ToString();
    ...
    protected void btnFind_Click(object sender, EventArgs e)
    {
        ...
        if (purmst != null)
        {
            ...
            txtDiscountAmount.Text = Convert.ToDouble(purmst.Discount).ToString("N0");
            ...
            txtGrandTotal.Text =
                (Convert.ToDecimal(txtTotalAmount.Text) - Convert.ToDecimal(txtDiscountAmount.Text)).ToString();
            tabVch.Visible = true;
    ...
    private void CashReport()
    {
        ...
        // cell.FixedHeight = 20f;
        dth.AddCell(cell);
        cell = new PdfPCell(new Phrase("Purchase Voucher(PV)", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 10, iTextSharp.text.Font.BOLD)));
        cell.HorizontalAlignment = 1;
        cell.VerticalAlignment = 1;
        cell.Colspan = 7;
        cell.BorderWidth = 0f;
        ...
        dtempty.AddCell(cell);
         ...
         float[] widthdtl = new float[6] { 12,  50, 20,20, 20, 25 };
       ...
       // cell.Rowspan = 2;
        ...
        cell = new PdfPCell(FormatPhrase(TotalAmount.ToString("N0")));
        cell.FixedHeight = 20f;
        cell.HorizontalAlignment = 2;
        cell.VerticalAlignment = 1;
        cell.BorderColor = BaseColor.LIGHT_GRAY;
        ...
        cell = new PdfPCell(FormatPhrase("Disconut Amount :"));
        cell.FixedHeight = 20f;
        cell.HorizontalAlignment = 2;
        cell.VerticalAlignment = 1;
        cell.BorderWidth = 0f;
        ...
        cell = new PdfPCell(FormatPhrase(txtDiscountAmount.Text));
        cell.FixedHeight = 20f;
        cell.HorizontalAlignment = 2;
        cell.VerticalAlignment = 1;
        cell.BorderWidth = 0f;
        ...
        cell = new PdfPCell(FormatPhrase(txtTotPayment.Text));
        cell.FixedHeight = 20f;
        cell.HorizontalAlignment = 2;
        cell.VerticalAlignment = 1;
        cell.BorderWidth = 0f;
