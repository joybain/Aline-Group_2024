...
<asp:Panel ID="pnlTask" runat="server" Visible="false" Width="100%" 
            ...
            <tr>
                    ...
                    <td align="center" colspan="2" style="vertical-align:top;" valign="middle">
                        <div class="row" style="padding-top: 20px; font-size: x-small;">
                            ...
                            <div class="col-xs-6 col-md-2">
                                <a  class="mnu-box" target="_blank" href="frmMaterialRequisition.aspx?mno=1.0">
                                   Total Requisition:<asp:Label ID="lblMatiralQnty"
                                    runat="server" Text="0" ForeColor="#CC3300"></asp:Label>
                                    <br />
                                    Authorize:<asp:Label ID="lblAuthorize"
                                    runat="server" Text="0" ForeColor="#CC3300"></asp:Label>  
                                    <br />
                                    NonAuthorize:<asp:Label ID="lblNonAuthorize"
                                    runat="server" Text="0" ForeColor="#CC3300"></asp:Label>                            
                                 <br />
                                <h3>
                                    Material Requisition</h3>
                                </a>
                            </div>
                            <div class="col-xs-6 col-md-2">
  ...
  <td style="width:40%; vertical-align:top;" align="center" valign="middle">         
      <br />
      <br />
      <br />
      <br />
