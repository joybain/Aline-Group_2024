...
//******************Project Wish Distrubation Report************* 
        else  if (rdbReportType.SelectedValue == "PWR")
        {

            DataTable dt = distrubationManager.GetShowREportDistrubation(ddlProjectName.SelectedValue, txtFromDatePWS.Text, txtToDatePWS.Text, "", "", "", "", "", "1", "PWR");
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Panel1.Visible = true;
                var ProjectName = ddlProjectName.SelectedItem.Text;
                // ReportParameter s2=new ReportParameter("ReportDate",);
                string RptType = "";

                rptOthersreportviewer.ProcessingMode = ProcessingMode.Local;
                rptOthersreportviewer.LocalReport.ReportPath = Server.MapPath("Report/ProjectWishReport.rdlc");
                rptOthersreportviewer.LocalReport.DataSources.Clear();
                rptOthersreportviewer.LocalReport.SetParameters(new ReportParameter("ReportType", ""));
                rptOthersreportviewer.LocalReport.SetParameters(new ReportParameter("ProjectName", ProjectName.ToString()));
                rptOthersreportviewer.LocalReport.SetParameters(new ReportParameter("ReportDate", DateTime.Now.ToString("dd/MM/yyyy")));
                //if (txtStartDategoods.Text != "")
                //{
                //    string date = "Date : " + txtStartDategoods.Text;
                ...
                //    rptOthersreportviewer.LocalReport.SetParameters(new ReportParameter("Date", date));
                //}
                rptOthersreportviewer.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", dt));
                rptOthersreportviewer.LocalReport.DataSources.Add(new ReportDataSource("Company", dt2));
                rptOthersreportviewer.LocalReport.Refresh();
            }
            else
        ...
        else if (rdbReportType.SelectedValue == "Os")
        {

            DataTable dt = distrubationManager.GetShowREportOprationSummery(ddlProjectName.SelectedValue);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                rptOthersreportviewer.ProcessingMode = ProcessingMode.Local;
                rptOthersreportviewer.LocalReport.ReportPath = Server.MapPath("Report/OprationSummery.rdlc");
                rptOthersreportviewer.LocalReport.DataSources.Clear();
                rptOthersreportviewer.LocalReport.SetParameters(new ReportParameter("ReportType", ""));
                rptOthersreportviewer.LocalReport.SetParameters(new ReportParameter("ProjectName", ProjectName.ToString()));
                rptOthersreportviewer.LocalReport.SetParameters(new ReportParameter("ReportDate", DateTime.Now.ToString("dd/MM/yyyy")));
                ...
                //    rptOthersreportviewer.LocalReport.SetParameters(new ReportParameter("Date", date));
                //}
                rptOthersreportviewer.LocalReport.DataSources.Add(new ReportDataSource("OprationSummery", dt));
                rptOthersreportviewer.LocalReport.DataSources.Add(new ReportDataSource("Company", dt2));
                rptOthersreportviewer.LocalReport.Refresh();
            }
            else
    ...
    protected void rdbReportType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else if (rdbReportType.SelectedValue == "Os")
        {
            ...
            pnlOrderReceived.Visible = false;
            pnlStock.Visible = false;
            pnlProjectWish.Visible = true;
            Label16.Visible = txtFromDatePWS.Visible = Label15.Visible = txtToDatePWS.Visible = false;
        }
        ...
        else if (rdbReportType.SelectedValue == "PWR" || rdbReportType.SelectedValue == "PWS")
        {
            pnlPurchase.Visible = false;
            pnlITS.Visible = false;
            pnlOrderReceived.Visible = false;
    ...
    protected void btnInventoryClear_Click(object sender, EventArgs e)
    {
        ...
        lblItemsIDPur.Text = lblItemIDStk.Text = lblItemIDPurchase.Text = lblItemIDORC.Text = txtDatefromPur.Text = txtDateToPur.Text = txtFromDateORC.Text = txtSearchItemORC.Text = txtSearchItemPur.Text = txtSearchItemStk.Text = txtToDateORC.Text =txtToDatePWS.Text=txtFromDatePWS.Text= "";
        ddlCatagory.SelectedIndex =
            ddlSubCatagory.SelectedIndex = ddlSupplierpur.SelectedIndex = ddlProjectName.SelectedIndex = -1;
        rptOthersreportviewer.Reset();
