...
<script language="javascript" type="text/javascript" >
    ...
    function TotSumation() {
        ...
        var txtTotDiscount = document.getElementById("<%=txtDiscountAmount.ClientID %>");
        ...
        if (parseFloat(txtTotCharge.value) < parseFloat(txtChequeAmount.value)) {
            ...
            txtDue.value = (txtTotCharge.value - txtTotDiscount.value - txtChequeAmount.value);
            txtGrandTotal.value = (txtTotCharge.value - txtTotDiscount.value);
        }
    }
    function Remarks() {
...
<table id="Table1" style="width:100%"  cellpadding="2">
	...
	<td style="width: 16%; height: 20px;" align="left">
	<asp:Label ID="Label10" runat="server" Font-Size="9pt">Address</asp:Label></td>
	<td style="width: 25%; height: 20px;" align="left">
  <asp:TextBox ID="txtSite" runat="server" Width="70%" Enabled="False" 
    ...
    <asp:TextBox SkinId="tbPlain" ID="txtPO" runat="server" Width="60%" CssClass="tbc" placeholder="Search PO. No - Supplier - PO. Date" TabIndex="3"
            ...
            <ajaxtoolkit:AutoCompleteExtender ID="txtPO_AutoCompleteExtender"
                                                        ...
                                                        EnableCaching="true" MinimumPrefixLength="2"
                                                        ServiceMethod="GetShowPONo1" ServicePath="~/AutoComplete.asmx"
    ...
    <td style=" width:7%;">
        <asp:Label ID="lblRequtionId" runat="server" Font-Size="9pt" Visible="False"></asp:Label>
        </td>    
    <td style="width: 16%; height: 20px;" align="left">
           ...
           <td style="height: 27px">
            ...
            <tr>
             ...
             <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td align="right"><asp:Label ID="Label6" runat="server" Font-Size="9pt">Discount Amount</asp:Label></td>
                <td>&nbsp;</td>
                <td><asp:TextBox ID="txtDiscountAmount" runat="server" CssClass="tbc" 
                        Font-Size="8pt" TabIndex="13" onChange="TotSumation();"
                        onfocus="this.select();" SkinID="tbPlain" style="text-align:right;" 
                  Width="92%" onkeypress="return isNumber(event)"></asp:TextBox></td>
           </tr>
             ...
             <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td align="right"><asp:Label ID="Label7" runat="server" Font-Size="9pt">Grand Total</asp:Label></td>
                <td>&nbsp;</td>
                <td><asp:TextBox ID="txtGrandTotal" runat="server" CssClass="tbc" Font-Size="8pt" TabIndex="13"
                        onfocus="this.select();" SkinID="tbPlain" style="text-align:right;" 
                  Width="92%" Enabled="False" onkeypress="return isNumber(event)" ReadOnly="True"></asp:TextBox></td>
           </tr>
