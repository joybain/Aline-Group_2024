            ...
            try
            {
              ...
              // CultureInfo enUS = new CultureInfo("bn-BD"); 
                ...
                if (dt.Rows.Count>0)
                {
                   ...
                   //lQty.Text = dt.Rows[0]["Data7"].ToString();
                    //lblDmAmn.Text = dt.Rows[0]["Data4"].ToString();
                   //lblDmQty.Text = dt.Rows[0]["Data8"].ToString();
                    lblMatiralQnty.Text = IdManager.GetShowSingleValueIntNotParameter("Count(id)", "MaterialRequisitionMst").ToString();
                   lblNonAuthorize.Text= IdManager.GetShowSingleValueIntTowParameter("Count(id)", "", "MaterialRequisitionMst", " AutherizStatus is Null").ToString();
                   lblAuthorize.Text = IdManager.GetShowSingleValueIntTowParameter("Count(id)", "", "MaterialRequisitionMst", " AutherizStatus is not Null ").ToString();
