    ...
    <asp:Image ID="imgEmp" runat="server" Width="145px" BorderStyle="Solid" 
        ...
        <tr>
            ...
            <td style="width: 57px">
                &nbsp;</td>
            <td align="left" style="width: 129px">
                <asp:Label ID="lblAssest" runat="server" Text="Assest Qnty"></asp:Label></td>
            <td style="width: 167px">
                <asp:TextBox ID="txtAssest" runat="server" onfocus="this.select();" 
                    onkeypress="return isNumber(event)" style="text-align:right;" Width="90%"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="left" style="width: 101px">
        ...
        <tr>
            ...
            <td style="width: 167px">
                ...
                <asp:TextBox ID="txtUnitPrice" runat="server" onfocus="this.select();" 
                    onkeypress="return isNumber(event)" style="text-align:right;" Width="90%"></asp:TextBox>
        ...
        <tr style="">
            ...
            <td style="height: 22px; width: 250px;" align="left">      
               <asp:TextBox ID="txtBranchSalesPrice" runat="server" Width="95%" 
                    ...
                    onfocus="this.select();" Visible="False"></asp:TextBox>
            </td>
            <td style="height: 22px; width: 57px;" align="left">      
                        ...
                        <tr>
                            ...
                            <td>
                                        ...
                                        <asp:RadioButtonList ID="chkItemsType" runat="server" RepeatDirection="Horizontal" 
                                            ...
                                            <asp:ListItem Value="5" onclick="UncheckOthers(this);">Fixed Asset </asp:ListItem>
