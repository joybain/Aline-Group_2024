...
{    
    public class SupplierManager
    {
        ...
        public static DataTable GetSuppliers()
        {
            ...
            string query = "select t1.*,t2.COUNTRY_DESC from Supplier t1 Left join COUNTRY_INFO t2 on t2.COUNTRY_CODE=t1.Country WHERE t1.[DeleteBy] IS NULL order by ID DESC ";
