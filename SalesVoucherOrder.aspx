<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SalesVoucherOrder.aspx.cs" Inherits="SalesVoucherOrder" %>
...
<table id="Table1" style="width:100%;">
	...
	<asp:Label ID="lblQuotNo" runat="server" Font-Size="9pt">Order No</asp:Label></td>
	...
	<asp:Label ID="lblQuotDate" runat="server" Font-Size="9pt" Font-Bold="True">Date</asp:Label></td>
	<td style="width: 30%; " align="left">
	...
	<td style="width: 30%; " align="left">
        ...
        <asp:DropDownList ID="ddlCustomer" runat="server" AutoPostBack="True" 
            ...
            onChange="changetextbox();" SkinID="ddlPlain" 
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 15%">
                        ...
                        <asp:TextBox ID="txtOrderNo" runat="server" Visible="False"  AutoPostBack="True" Width="98%"></asp:TextBox>
                    ...
                    <td style="width: 15%">
                     ...
                     <%--   <asp:TextBox ID="txtSearchSuplier" runat="server" AutoPostBack="True" 
                            ontextchanged="txtSearchSuplier_TextChanged" PlaceHolder="Search Customer" 
                ...
                <tr>
                    <td style="width: 10%">
                        &nbsp;</td>
                    <td align="right" style="width: 12%">
                        <asp:Label ID="Label40" Visible="False" runat="server" Text="From Date"></asp:Label>
                    </td>
                    <td style="width: 3%">
                        &nbsp;</td>
                    <td style="width: 15%">
                        <asp:TextBox ID="txtFromDate" Visible="False" runat="server" Width="98%"></asp:TextBox>
                        <cc:CalendarExtender ID="Calendarextender3" runat="server" Format="dd/MM/yyyy" 
                            TargetControlID="txtFromDate" />
                    </td>
                    <td align="right" style="width: 12%">
                        <asp:Label ID="Label41" Visible="False" runat="server" Text="To Date"></asp:Label>
                    </td>
                    <td style="width: 3%">
                        &nbsp;</td>
                    <td style="width: 15%">
                        <asp:TextBox ID="txtToDAte" Visible="False" runat="server" Width="98%"></asp:TextBox>
     ...
     <ContentTemplate>--%>
         <table style="width:100%;"><tr>
                         ...
                         <asp:TemplateField HeaderText="Item Code">
                             <ItemTemplate>
                                 <asp:TextBox ID="txtItemCode" runat="server" 
                                     AutoPostBack="true" Font-Size="8pt" MaxLength="15" ReadOnly="True"
          ...
          <ajaxToolkit:AutoCompleteExtender ServicePath="AutoComplete.asmx" runat="server" 
           ...
           ServiceMethod="GetItemListSalesBarcode" MinimumPrefixLength="1" CompletionInterval="10" EnableCaching="true" 
