    ...
    <table style="width: 100%;line-height:1.5em;" >
        ...
        <tr>
            <td align="right" style="width: 134px; height: 26px;">
	            <asp:Label ID="lblddlCat" Visible="False" runat="server" Text="Category"></asp:Label>
            </td>
            <td style="width: 14px; height: 26px;">
                </td>
            <td align="left" style="height: 26px">
                <asp:DropDownList ID="ddlCatagory" runat="server" AutoPostBack="True" 
                    Enabled="False" Font-Size="8pt" Height="26px" Visible="False"
	    ...
	    <asp:Label ID="Label24" runat="server" Visible="False" Text="Department" Font-Size="9pt"></asp:Label>
            </td>
            <td style="width: 14px; height: 28px;">
                </td>
            <td align="left" style="height: 28px">
                <asp:DropDownList ID="ddlDepart" runat="server" Height="26px" Visible="False"  Width="98%" 
